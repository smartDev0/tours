                                	...
                                	<div class="row">
										...
										<div class="col-lg-4">
											...
											<ul>
												...
												<li><a href="general_page.html"><i class="icon-light-up"></i>  General Page</a></li>                                             
											</ul>
										</div>
                                    </div><!-- End row -->
                                </div><!-- End menu-wrapper -->
    ...
    <div class="row">
        <div class="col-lg-8" id="single_tour_desc">
			 ...
			 <div class="text-center">
				...
				<p><strong>Message Successfully Sent!</strong><br />
				  We will contact you shortly to confirm your request!</p>
								...
								$subject = "Message From CityTours";
								$headers = "From: CityTours <noreply@yourdomain.com>";
								$message = "Message for HOTEL Concordia Paris\n";
								...
								//Confirmation page
								$user = "$mail";
								$usersubject = "Thank You from CityTours";
								$userheaders = "From: info@citytours.com\n";
								//Confirmation page WITH  SUMMARY
								$usermessage = "Thank you for your time, message sent!.\nWe will contact you shortly!\n\n$message"; 
