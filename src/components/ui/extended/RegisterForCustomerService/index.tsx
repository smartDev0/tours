...
import {
  ...
  WrapperContainer,
} from "components/ui/extended/RegisterForCustomerService/index.style";
                  ...
                  <Col lg={5}>
                    <HeadingContainer>
                      <Fade direction={"up"}>
                        <Heading level={2}>
                          {t(
                            "components.ui.extended.RegisterForCustomerService.title"
                          )}
                        </Heading>
                      </Fade>
                      <Fade direction={"up"}>
                        <p>
                          {t(
                            "components.ui.extended.RegisterForCustomerService.description"
                          )}
                        </p>
                      </Fade>
                      <Fade direction={"up"}>
