...
export interface FullWidthCarouselContainerProps {
  maxWidth?: number;
}
...
const StyledFullWidthCarousel = styled.section`
  text-align: center;
...
const FullWidthCarouselContainer = styled(
  Container
)<FullWidthCarouselContainerProps>`
  ${(props) =>
    props.maxWidth &&
    `
      max-width: ${props.maxWidth}px;
...
const FullWidthCarouselCenteredCol = styled(Col)`
  display: flex;
  justify-content: center;
  align-items: center;
`;

const FullWidthCarouselCol = styled(FullWidthCarouselCenteredCol)`
